        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-8">
          ...
          <div>
            ...
            <ul className="space-y-2">
              <li>
                <Link href="/explore" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                  Find PG
                </Link>
              </li>
              <li>
                <Link href="/partner" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                  List Property
                </Link>
              </li>
              <li>
              ...
              <li>
                <Link href="/careers" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                  Careers
                </Link>
              </li>
            </ul>
          ...
          <div>
            ...
            <ul className="space-y-2">
              ...
              <li>
                <Link href="/safety" className="text-gray-300 dark:text-gray-400 hover:text-white transition-colors">
                  Safety Information
                </Link>
              </li>
            </ul>
