...
async function main() {
  ...
  const pgImages = [
    ...
    "https://images.unsplash.com/photo-1556912167-f556f1de5c9e?w=800",
    "https://images.unsplash.com/photo-1596916643091-0b2d77bb7b1a?w=800",
    "https://images.unsplash.com/photo-1502672260266-1c1ef2d93688?w=800",
  ...
  // Create PG Data with nearbyFacilities as JSON array and city field
  ...
  const pgListings = await Promise.all([
    prisma.pgData.create({
      data: {
        ...
        description: "Spacious rooms, close to Manyata Tech Park. Ideal for IT professionals.@Bangalore, Karnataka 560045",
    ...
    prisma.pgData.create({
      data: {
        ...
        description: "Safe and secure PG for women. Walking distance to metro station.@4th Block, Bangalore, Karnataka 560011",
    ...
    prisma.pgData.create({
      data: {
        ...
        description: "Modern co-living space with gym and common area.@Bangalore, Karnataka 560037",
    ...
    prisma.pgData.create({
      data: {
        ...
        hostId: hostProfiles[0].id,
        description: "Affordable PG for students and bachelors.@Yeshwanthpur, Bangalore, Karnataka 560022",
        propertyType: PropertyType.MEN,
        foodIncluded: true,
    ...
    prisma.pgData.create({
      data: {
        ...
        hostId: hostProfiles[1].id,
        description: "Premium PG with AC rooms and daily housekeeping.@MG Road, Bangalore, Karnataka 560001",
        propertyType: PropertyType.WOMEN,
        foodIncluded: true,
        furnishing: FurnishingType.FURNISHED,
        address: "Marathahalli",
    ...
    prisma.pgData.create({
      data: {
        ...
        hostId: hostProfiles[0].id,
        description: "PG with attached bathrooms and 24/7 security.@Bannerghatta, Bangalore, Karnataka 560076",
        propertyType: PropertyType.MEN,
        foodIncluded: false,
        furnishing: FurnishingType.SEMI_FURNISHED,
    ...
    prisma.pgData.create({
      data: {
        ...
        hostId: hostProfiles[2].id,
        description: "PG with coworking space and rooftop cafe.@Sarjapur Road, Bangalore, Karnataka 560035",
        propertyType: PropertyType.COLIVE,
        foodIncluded: false,
        furnishing: FurnishingType.FURNISHED,
        address: "Sarjapur",
  ...
  const sharingTypes = await Promise.all([
    ...
    // Continue with the rest of the sharing types for remaining PGs...
    // Adding single sharing type for each remaining PG
    ...Array.from({ length: pgListings.length - 5 }, (_, i) => ({
      type: SharingTypeEnum.SINGLE,
      description: "Luxury single room with premium amenities",
      price: 25000,
      availability: 1,
      pgDataId: pgListings[i + 5].id,
      pricePerMonth: 25000,
      pricePerDay: 850,
      deposit: 50000,
      refundableDeposit: true,
      ...
      createdAt: new Date(),
      updatedAt: new Date(),
    })).map(data => prisma.sharingType.create({ data }))
  ]);
  ...
  const furnitureByPg = [
    ...
    // Repeat furniture patterns for remaining PGs
    ...Array(18).fill([
      FurnitureType.BED,
      FurnitureType.WARDROBE,
      FurnitureType.SOFA,
  ...
  const amenitiesByPg = [
    ...
    // Repeat amenity patterns for remaining PGs
    ...Array(18).fill([
      AmenityType.WIFI,
      AmenityType.PARKING,
      AmenityType.SECURITY,
